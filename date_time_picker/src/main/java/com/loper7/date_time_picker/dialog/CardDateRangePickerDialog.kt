 ...
 */
open class CardDateRangePickerDialog(context: Context) :
    ...
    private var tv_choose_date2: TextView? = null
    private var datePicker: DateTimePicker? = null
    private var datePicker2: DateTimePicker? = null
    ...
    private var divider_top2:View?=null
    private var divider_top3:View?=null
    private var divider_top4:View?=null
    private var divider_bottom:View?=null
    private var divider_line:View?=null

    private var millisecond: Long = 0
    private var millisecond2: Long = 0
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        setContentView(R.layout.dtr_dialog_time_picker)
        ...
        datePicker2 = findViewById(R.id.dateTimePicker2)
        tv_title = findViewById(R.id.tv_title)
        tv_choose_date = findViewById(R.id.tv_choose_date)
        tv_choose_date2 = findViewById(R.id.tv_choose_date2)
        linear_bg = findViewById(R.id.linear_bg)
        divider_top = findViewById(R.id.divider_top)
        divider_top2 = findViewById(R.id.divider_top2)
        divider_top3 = findViewById(R.id.divider_top3)
        divider_top4 = findViewById(R.id.divider_top4)
        ...
        datePicker2!!.setLayout(builder!!.pickerLayoutResId)
        ...
        datePicker2!!.setDisplayType(builder!!.displayTypes)
        //回到当前时间展示
        if (builder!!.displayTypes != null) {
        ...
        tv_choose_date2!!.visibility = if (builder!!.focusDateInfo) View.VISIBLE else View.GONE
        ...
        //强制关闭国际化（不受系统语言影响）
        datePicker2!!.setGlobal(DateTimeConfig.GLOBAL_LOCAL)
        //设置最小时间
        datePicker2!!.setMinMillisecond(builder!!.minTime)
        //设置最大时间
        datePicker2!!.setMaxMillisecond(builder!!.maxTime)
        //设置默认时间
        datePicker2!!.setDefaultMillisecond(builder!!.defaultMillisecond)
        //设置是否循环滚动
        datePicker2!!.setWrapSelectorWheel(
            builder!!.wrapSelectorWheelTypes,
            builder!!.wrapSelectorWheel
        )

        datePicker!!.setTextSize(13, 15)
        datePicker2!!.setTextSize(13, 15)
        if (builder!!.themeColor != 0) {
            datePicker!!.setThemeColor(builder!!.themeColor)
            datePicker2!!.setThemeColor(builder!!.themeColor)
        ...
        if (builder!!.assistColor != 0) {
            ...
            tv_choose_date2?.setTextColor(builder!!.assistColor)
            tv_cancel?.setTextColor(builder!!.assistColor)
            datePicker!!.setTextColor(builder!!.assistColor)
            datePicker2!!.setTextColor(builder!!.assistColor)


        }
        if (builder!!.dividerColor != 0) {
            divider_top?.setBackgroundColor(builder!!.dividerColor)
            divider_top2?.setBackgroundColor(builder!!.dividerColor)
            divider_top3?.setBackgroundColor(builder!!.dividerColor)
            divider_top4?.setBackgroundColor(builder!!.dividerColor)
            ...
            datePicker2!!.setDividerColor(builder!!.dividerColor)
        }
        ...
        datePicker!!.setOnDateTimeChangedListener { millisecond ->
            this@CardDateRangePickerDialog.millisecond = millisecond
            var calendar = Calendar.getInstance()
            calendar.clear()
            calendar.timeInMillis = millisecond
            tv_choose_date?.text =
                StringUtils.conversionTime(millisecond, "EEE, dd MMM yyyy")
        }

        datePicker2!!.setOnDateTimeChangedListener { millisecond ->
            this@CardDateRangePickerDialog.millisecond2 = millisecond
            var calendar = Calendar.getInstance()
            calendar.clear()
            calendar.timeInMillis = millisecond
            tv_choose_date2?.text =
                StringUtils.conversionTime(millisecond, "EEE, dd MMM yyyy")
        }
    }
    ...
    override fun onClick(v: View) {
        ...
        when (v.id) {
            R.id.dialog_submit -> {
                builder?.onChooseListener?.invoke(millisecond, millisecond2)
            }
            R.id.dialog_cancel -> {
    ...
    class Builder(private var context: Context) {
        ...
        @JvmField
        var onChooseListener: ((Long, Long) -> Unit)? = null
         ...
         * @return Builder
         */
        fun setOnChoose(text: String = "确定", listener: ((Long, Long) -> Unit)? = null): Builder {
        ...
        fun build(): CardDateRangePickerDialog {
            return CardDateRangePickerDialog(context, this)
        }
    }
